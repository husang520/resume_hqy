...
\setCJKfamilyfont{yh}{Noto Sans CJK SC}
\newcommand{\yh}{\CJKfamily{yh}}
...
\firstname{胡}
\familyname{千一}
\title{Qianyi Hu}  % optional, remove the line if not wanted
% \address{杭州}{}  % optional, remove the line if not wanted
\address{2000/06/25}{}  % optional, remove the line if not wanted
\mobile{13855353881}  % optional, remove the line if not wanted
% \fax{fax (optional)}  % optional, remove the line if not wanted
\email{husang520@gmail.com}  % optional, remove the line if not wanted
\homepage{Blog: https://frp-six.com:28650}  % optional, remove the line if not wanted
\social[github]{GitHub: https://github.com/husang520}
\extrainfo{%
...
\photo[64pt]{avatar1.jpg}  % '64pt' is the height the picture must be resized to and 'picture' is the name of the picture file; optional, remove the line if not wanted
...
\section{求职意向}
\cvline{教学年级}{小学/初中/高中}
\cvline{可授科目}{数学、物理、化学、计算机基础等}
\cvline{授课方式}{一对一辅导、作业辅导、基础巩固、考前冲刺、线上/线下授课}
\cvline{期望方向}{帮助学生夯实基础、掌握学习方法、提高学习兴趣和考试成绩}

\section{教育背景}
\cventry{18.09--22.06}{本科}{安徽工业大学}{测控技术与仪器专业}{}{%
本科期间学习成绩优异，专业基础扎实，曾获得校级一等奖学金、校级优秀学生、优秀毕业生等荣誉。系统学习高等数学、大学物理、电路原理、自动控制原理、传感器技术、单片机原理等课程，具备较强的数学基础、逻辑思维能力和工程实践能力。}
\cventry{22.09--25.06}{研究生}{华东理工大学}{控制科学与工程}{推荐免试研究生}{%
因本科阶段综合表现优秀，获得推荐免试研究生资格，推免至华东理工大学控制科学与工程专业。研究生期间继续深耕自动控制、系统建模、智能控制、优化方法等方向，具备较强的学习能力、科研能力和问题分析能力。多年的理工科学习经历使本人能够将复杂知识点进行拆解和归纳，并用通俗清晰的方式帮助学生理解和掌握。}

\section{家教经验}
\cventry{18.06--18.09}{小学/初中作业辅导}{课后辅导}{}{}{%
负责学生日常作业检查、知识点讲解和学习习惯培养。在辅导过程中注重耐心沟通，及时发现学生在听课、做题和复习中的问题，并通过举例讲解、步骤拆分、反复练习等方式帮助学生理解知识点，提高作业完成质量和学习效率。
}

\cventry{23.09--24.02}{初中数学家教}{一对一辅导}{}{}{%
主要负责学生数学基础知识巩固、课后作业辅导、错题讲解和阶段性复习。根据学生薄弱环节制定针对性辅导计划，重点帮助学生理解公式原理、掌握解题思路，并养成整理错题和复盘总结的习惯。经过一段时间辅导，学生学习主动性有所提高，基础知识掌握更加扎实。}

\section{教学方法}
\cvline{因材施教}{根据学生基础、性格特点和学习习惯制定不同的辅导方式，避免机械讲题，注重帮助学生真正理解知识。}
\cvline{重视基础}{从课本知识点、基本公式、典型例题入手，帮助学生建立完整的知识框架。}
\cvline{错题复盘}{引导学生整理错题，分析错误原因，总结同类题型的解题方法，减少重复性错误。}
\cvline{及时反馈}{课后可向家长反馈学生学习情况，包括掌握程度、存在问题和后续学习建议。}

% \section{个人优势}
% \cvline{责任心强}{对学生认真负责，能够按时备课、认真讲解，并根据学生情况及时调整辅导计划。}
% \cvline{表达清晰}{善于把复杂知识点拆分成简单步骤，讲解有条理，便于学生理解和吸收。}
% \cvline{耐心细致}{能够耐心解答学生问题，鼓励学生主动思考，帮助学生建立学习信心。}
% \cvline{沟通能力}{能够与学生和家长保持良好沟通，及时了解学习需求和辅导效果。}

\section{可授课程}
\cvline{小学阶段}{语文、数学、英语、作业辅导、学习习惯培养}
\cvline{初中阶段}{数学、英语、物理、基础巩固、同步辅导、考试复习}
\cvline{高中阶段}{高中数学、高中物理等}
\cvline{其他方向}{计算机基础、编程入门、办公软件基础等}

\section{时间安排}
\cvline{可授课时间}{周六下午，周日全天，具体时间可协商}
\cvline{授课地点}{学生家中、公共学习场所或线上授课，具体方式可协商}
